...
# Define the MPO
H, L, R = one_over_x.get_H_inversef(N, rescale)
...
psi = mpsut.generate_random_MPS (N, d=2, D=12)


# Define the bond dimensions for the sweeps
maxdims = [12]*100 + [144]*40 + [1728]*50 + [20736]*60 + [248832]*200
cutoff = 1e-9
...
#np.savetxt('a1.dat',(xs,fs2))
#np.savetxt('a2.dat',(xs,fs3))
